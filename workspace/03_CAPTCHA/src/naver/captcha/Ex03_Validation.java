...
public class Ex03_Validation{
    ...
    public static void main(String[] args) {
    	// 네이버 캡차 API 예제 - 키발급
        String clientId = "zHNXKwZyAvitCf25Vh6J"; //애플리케이션 클라이언트 아이디값";
        String clientSecret = "3bADLuF4MI"; //애플리케이션 클라이언트 시크릿값";
        ...
        // 네이버가 응답한 JSON데이터 : {"key":"xei9iKTL4ISGAX4Q"}
        ...
        String key = (String)obj.get("key"); // get() 메소드
        ...
        // responseBody : {"result":true, "responseTrime":2}
        System.out.println(responseBody);
