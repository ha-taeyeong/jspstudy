...
<body>
	<div class="container">
		<form id="f" action="pwChange.jsp" method="post">
			<label for = "pw0">현재 비밀번호<input type="password" id="pw0"></label><br>
			<label for = "pw">새 비밀번호<input type="password" name="pw" id="pw"></label><br>
			<label for = "pw1">비밀번호 확인<input type="password" id="pw1"></label><br>
