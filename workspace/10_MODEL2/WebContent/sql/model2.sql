...
ALTER TABLE MEMBER_LOG ADD CONSTRAINT LOG_PK PRIMARY KEY(NO);
ALTER TABLE BOARD ADD CONSTRAINT BOARD_PK PRIMARY KEY(IDX);
ALTER TABLE REPLY ADD CONSTRAINT REPLY_PK PRIMARY KEY(IDX);

-- 외래키
ALTER TABLE MEMBER_LOG ADD CONSTRAINT MEMBER_LOG_FK _MEMBER_FK FOREIGN KEY(ID) REFERENCES MEMBER(ID);
ALTER TABLE BOARD ADD CONSTRAINT BOARD_MEMBER_FK FOREIGN KEY(AUTHOR) REFERENCES MEMBER(ID);
ALTER TABLE REPLY ADD CONSTRAINT REPLY_BOARD_FK FOREIGN KEY(AUTHOR) REFERENCES MEMBER(ID);
...
CREATE SEQUENCE MEMBER_LOG INCREMENT BY 1 START WITH 1 NOCYCLE NOCACHE;
